...
To obtain an instance of the PortalObjectsMgmtClient to communicate with a portal running @ http://localhost:8080/portal/ using
credentials root/gtn (default admin password)
