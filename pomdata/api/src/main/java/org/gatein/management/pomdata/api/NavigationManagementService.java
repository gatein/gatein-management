...
public interface NavigationManagementService
{
    ...
    * @param ownerId the ownerId of the navigation, ie: classic, /platform/users, etc
    * @return
    * @throws ManagementException
    */
   NavigationData getNavigation(String ownerType, String ownerId) throws ManagementException;

   NavigationData getNavigation(String ownerType, String ownerId, String navigationPath) throws ManagementException;
}
